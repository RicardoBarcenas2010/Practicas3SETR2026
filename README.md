Integrantes:
    Ricardo Gabriel Bárcenas Benítez
    Daniela Lendalí Valle Campos
...
2. Respuestas a preguntas guia
 ...
 f) Ventajas de pvParameters:
   ...
   práctica se usó para:
    ...
    Esto evita crear funciones separadas para cada LED o botón.
  ...
  g) Ventajas de TaskHandle_t:
     ...
     En la práctica, el Task Manager usa handles para suspender y reanudar
  ...
  Aunque g_system es global, está encapsulada en un módulo y se accede
    ...
    - Habría condiciones de carrera (varias tareas modificando)
     - No se podría pausar y reanudar limpiamente
